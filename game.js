...
var helpDescription =
    ...
    '<p>Маленький кружок красного цвета отмечает ваше местоположение.' +
    '<p>Кружками зелёного цвета обозначено подключенное оборудование. Злоумышленники могут добраться до узлов и взломать их, нарушив таким образом работу оборудования. Сломанное оборудование отображается кружками оранжевого цвета.' +
